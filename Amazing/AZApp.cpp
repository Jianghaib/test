...
void App::Load(Platform::String^ entryPoint)
{
	if (m_main == nullptr)
	{
		m_main = std::unique_ptr<AmazingMain>(new AmazingMain(m_deviceResources));
	}
}
...
bool Amazing::App::CreateRenderThread()
{
	return false;
}

bool Amazing::App::CreateRenderer()
{
	return false;
}

bool Amazing::App::CreateSceneManager()
{
	return false;
}
